...
tfidf.fit(first_heard_other_df['text'])
tfidf_text = tfidf.transform(first_heard_other_df['text'])
...
plt.show()
# -- Optimal at 28 clusters

print('Training clusters...')
clusters = MiniBatchKMeans(n_clusters=28,
                           init_size=1024,
                           batch_size=2048,
                           random_state=20).fit_predict(tfidf_text)

print(cluster_counts(clusters))
