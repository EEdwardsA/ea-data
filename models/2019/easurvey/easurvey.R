list(
  ...
  data   = list(
    ...
    , "Make % inc donate" = function(df) {
        p <- df$donate_2018_c / df$income_2018_c
        p[is.infinite(p)] <- NA
        p[is.nan(p)] <- NA
        df$p_donate_2018 <- p
        df
    ...
    , "Donations by cause area" = function(df) {
        ...
        for (cause in names(orgs_by_cause)) {
          ...
          df[[paste("donate", "cause", cause, "2018", "c", sep = "_")]] <- out
        }
        df
    }
  ...
  , analyze = list(
    ...
    list(
      ...
      , "summarize donations 2018"                = function(df) var_summary(df$donate_2018_c, verbose = TRUE)
      , "donations x student"                = function(df) ctab(df, donate_2018_c, student)
      , "summary donations for students"     = function(df) var_summary(dplyr::filter(df, student == "Yes")$donate_2018_c, verbose = TRUE)
      , "summary donations for non-students" = function(df) var_summary(dplyr::filter(df, student == FALSE)$donate_2018_c, verbose = TRUE)
      , "donation quantile 1"                = function(df) quantile(df$donate_2018_c, probs = seq(0.1, 1, len = 10), na.rm = TRUE)
      , "donation quantile 2"                = function(df) quantile(df$donate_2018_c, probs = seq(0.91, 1, len = 10), na.rm = TRUE)
      , "summarize % donations"         = function(df) var_summary(dplyr::filter(df, income_2018_c > 10000)$p_donate_2018 * 100, verbose = TRUE)
      , "% donation quantile"                = function(df) quantile(dplyr::filter(df, income_2018_c > 10000)$p_donate_2018 * 100, probs = seq(0.1, 1, len = 10), na.rm = TRUE)
      , "% donation breakdown"               = function(df) breakdown(dplyr::filter(df, income_2018_c > 10000), "p_donate_2018", c(0.01, 0.02, 0.03, 0.05, 0.1, 0.15, seq(0.2, 0.9, by =  0.1)))
      , "RC Donations (Total)"          = function(df) var_summary(df$donate_RC_2018_c, verbose = TRUE)
      , "Did donate to RC?"             = function(df) tab(df, donate_RC_2018_c > 0)
      , "80K Donations (Total)"         = function(df) var_summary(df$donate_80K_2018_c, verbose = TRUE)
      , "Did donate to 80K?"            = function(df) tab(df, donate_80K_2018_c > 0)
      , "ACE Donations 2018 (Total)"         = function(df) var_summary(df$donate_ace_2018_c, verbose = TRUE)
      , "Did donate to ACE 2018?"            = function(df) tab(df, donate_ace_2018_c > 0)
      , "AMF Donations 2018 (Total)"         = function(df) var_summary(df$donate_amf_2018_c, verbose = TRUE)
      , "Did donate to AMF 2018?"            = function(df) tab(df, donate_amf_2018_c > 0)
      , "CFAR Donations 2018 (Total)"        = function(df) var_summary(df$donate_cfar_2018_c, verbose = TRUE)
      , "Did donate to CFAR 2018?"           = function(df) tab(df, donate_cfar_2018_c > 0)
      , "CEA Donations 2018 (Total)"         = function(df) var_summary(df$donate_cea_2018_c, verbose = TRUE)
      , "Did donate to CEA 2018?"            = function(df) tab(df, donate_cea_2018_c > 0)
      , "DTW Donations 2018 (Total)"         = function(df) var_summary(df$donate_dtw_2018_c, verbose = TRUE)
      , "Did donate to DTW 2018?"            = function(df) tab(df, donate_dtw_2018_c > 0)
      , "EF Donations 2018 (Total)"          = function(df) var_summary(df$donate_ef_2018_c, verbose = TRUE)
      , "Did donate to EF 2018?"             = function(df) tab(df, donate_ef_2018_c > 0)
      , "GD Donations 2018 (Total)"     = function(df) var_summary(df$donate_gd_2018_c, verbose = TRUE)
      , "Did donate to GD 2018?"        = function(df) tab(df, donate_gd_2018_c > 0)
      , "GW Donations 2018 (Total)"     = function(df) var_summary(df$donate_gw_2018_c, verbose = TRUE)
      , "Did donate to GW 2018?"        = function(df) tab(df, donate_gw_2018_c > 0)
      , "GF Donations 2018 (Total)"     = function(df) var_summary(df$donate_gf_2018_c, verbose = TRUE)
      , "Did donate to GF 2018?"        = function(df) tab(df, donate_gf_2018_c > 0)
      , "MIRI Donations 2018 (Total)"   = function(df) var_summary(df$donate_miri_2018_c, verbose = TRUE)
      , "Did donate to MIRI 2018?"      = function(df) tab(df, donate_miri_2018_c > 0)
      , "MFA Donations 2018 (Total)"    = function(df) var_summary(df$donate_mfa_2018_c, verbose = TRUE)
      , "Did donate to MFA 2018?"       = function(df) tab(df, donate_mfa_2018_c > 0)
      , "SCI Donations 2018 (Total)"    = function(df) var_summary(df$donate_sci_2018_c, verbose = TRUE)
      , "Did donate to SCI 2018?"       = function(df) tab(df, donate_sci_2018_c > 0)
      , "THL Donations 2018 (Total)"    = function(df) var_summary(df$donate_thl_2018_c, verbose = TRUE)
      , "Did donate to THL 2018?"       = function(df) tab(df, donate_thl_2018_c > 0)
      , "Meta Cause Donations 2018 (Total)"  = function(df) var_summary(df$donate_cause_meta_2018_c, verbose = TRUE)
      , "Did donate to Meta Cause 2018?"     = function(df) tab(df, donate_cause_meta_2018_c > 0)
      , "Global Poverty Cause Donations 2018 (Total)"  = function(df) var_summary(df$donate_cause_poverty_2018_c, verbose = TRUE)
      , "Did donate to Global Poverty Cause 2018?"     = function(df) tab(df, donate_cause_poverty_2018_c > 0)
      , "Cause Prioritization Cause Donations 2018 (Total)"  = function(df) var_summary(df$donate_cause_cause_pri_2018_c, verbose = TRUE)
      , "Did donate to Cause Prioritization Cause 2018?"     = function(df) tab(df, donate_cause_cause_pri_2018_c > 0)
      , "Animal Welfare Cause Donations 2018 (Total)"  = function(df) var_summary(df$donate_cause_animal_welfare_2018_c, verbose = TRUE)
      , "Did donate to Animal Welfare Cause 2018?"     = function(df) tab(df, donate_cause_animal_welfare_2018_c > 0)
      , "Far Future Cause Donations 2018 (Total)"  = function(df) var_summary(df$donate_cause_far_future_2018_c, verbose = TRUE)
      , "Did donate to Far Future Cause 2018?"     = function(df) tab(df, donate_cause_far_future_2018_c > 0)
      ...
      , "gender x poverty donations"      = function(df) ctab(df, filter(donate_2018_c > 0), donate_cause_poverty_2018_c, gender_b)
      , "gender x AR donations"           = function(df) ctab(df, filter(donate_2018_c > 0), donate_cause_animal_welfare_2018_c, gender_b)
      # , "donations x ETG"                 = function(df) ctab(df, filter(student == FALSE), donate_2018_c, ea_career_type == "Earning to give")
      # , "age x ETG"                     = function(df) ctab(df, age, ea_career_type == "Earning to give", na.rm = TRUE)
      # , "total donations x ETG"         = function(df) df %>% group_by(ea_career_type == "Earning to give") %>% summarise(total_donations = sum(donate_2018_c, na.rm = TRUE)) %>% mutate(percent_donations = total_donations / sum(df$donate_2018_c, na.rm = TRUE))
      # , "ETG donations"                 = function(df) var_summary(dplyr::filter(df, ea_career_type == "Earning to give")$donate_2018_c, verbose = TRUE)
      ...
      , "Heard EA attributed donations" = function(df) { df %>% group_by(first_heard_EA) %>% summarise(sum(donate_2018_c, na.rm = TRUE)) %>% setNames(., list("first_heard_EA", "sum_donations")) %>% arrange(-sum_donations) }
      , "Heard EA attributed donations" = function(df) { df %>% group_by(first_heard_EA) %>% summarise(sum(donate_2018_c, na.rm = TRUE)) %>% setNames(., list("first_heard_EA", "sum_donations")) %>% arrange(-sum_donations) }
      , "Heard EA attributed donors"    = function(df) tab(df, first_heard_EA, donate_2018_c > 0, percent = TRUE, na.rm = TRUE)
      ...
      , "MIRI donations by year"        = function(df) ctab(df, filters(donate_2018_c > 0), donate_miri_2018_c, which_year_EA, na.rm = TRUE)
      , "AMF donations by year"         = function(df) ctab(df, filters(donate_2018_c > 0), donate_amf_2018_c, which_year_EA, na.rm = TRUE)
      , "AMF donations by first heard"  = function(df) ctab(df, filters(donate_2018_c > 0), donate_amf_2018_c, first_heard_EA, na.rm = TRUE)
      , "MIRI donations by first heard" = function(df) ctab(df, filters(donate_2018_c > 0), donate_miri_2018_c, first_heard_EA, na.rm = TRUE) 
      ...
      #, "first heard local x donate"    = function(df) ctab(df, donate_2018_c, first_heard_EA == "Local EA group")
      ...
      , "involved_local_EA x donate"    = function(df) ctab(df, donate_2018_c, involved_local_EA)
      ...
      , "member_local x donate"         = function(df) ctab(df, donate_2018_c, member_local_group)
      , "member_gwwc x involved local"  = function(df) ctab(df, member_gwwc, involved_local_EA)
      , "GWWC non-students donating >10%" = function(df) tab(df, filters(student == FALSE, income_2018_c > 10000, which_year_EA %not_in% c(2018, 2018)), member_gwwc, p_donate_2018 >= 0.1, na.rm = TRUE, percent = TRUE)
      ...
      , "cause donations x GWWC"        = function(df) { for (var in get_vars(df, "donate_2018_cause_.+2018")) { print(tab_(df, list(lazyeval::as.lazy(paste(var, "> 0")), "member_gwwc"), na.rm = TRUE)) } }
      , "Number of orgs people donate to" = function(df) { get_vars(df, "donate_.+2018_c") %>% grep("cause", ., invert = TRUE, value = TRUE) %>% df[, .] %>% apply(., 1, function(x) x > 0) %>% apply(., 2, sum) %>% table }
      ...
      #, "referrer3 x donation"          = function(df) ctab(df, filter(student == FALSE), donate_2018_c, referrer3)
      #, "referrer3 x income"            = function(df) ctab(df, filter(student == FALSE), income_2018_c, referrer3)
