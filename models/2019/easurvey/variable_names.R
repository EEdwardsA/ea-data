list(
 ...
 "Roughly how much did you donate to the following organizations in 2018? The Humane League" = "donate_thl_2018",
	...
	"If you’re interested in pursuing a career in an EA-affiliated cause area, select which cause areas:" = "ea_career_cause_mental_health",
	"If you’re interested in pursuing a career in an EA-affiliated cause area, select which cause areas: Animal welfare/rights" = "career_cause_animal_welfare",
