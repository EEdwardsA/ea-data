...
CONVERSION_AS_OF_DATE <- "2019-11-13" # A single date for currency conversions.

csv_path <- "data/2019/2019-ea-survey-anon.csv"
tryCatch({
...
readr::write_csv(data, "data/2019/2019-ea-survey-anon-currencied.csv")
message("...Written!")
